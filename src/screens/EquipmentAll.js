...
export default function ({ navigation }) {
  ...
  return (
    <Layout>
      <TopNav
        middleContent="Sale Equipment List All"
        leftContent={
          <Ionicons
            name="chevron-back"
            size={20}
...
{isLoading ? (
 ...
 <FlatList
   ...
   renderItem={ ({ item }) => { return ( <TouchableOpacity onPress={()=> navigation.navigate('EquipmentDetail')}>
        ...
        <View>
          ...
          <View style={styles.msgContainer}>
            <Text numberOfLines={2} style={styles.msgTxt}>{item.catid}  {"\n"} 
       
            <TouchableOpacity style={styles.shareButton} onPress={()=> navigation.navigate('EquipmentDetail')}>
